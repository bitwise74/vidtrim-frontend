...
{#if success}
    <div class="card shadow-lg border-0" style="max-width: 28rem; margin: 0 auto;">
        <div class="card-body p-5 text-center">
            ...
            <h3 class="h4 fw-semibold mb-3">Account Created!</h3>
            <p class="text-muted-foreground mb-4">
                Welcome to vid.sh! We've sent a verification email to {formData.email}
            </p>
            <div class="d-grid gap-3">
                <a href="/login" class="btn btn-gradient" aria-label="Continue to Login"
                    >Continue to Login</a
                >
                <a href="/" class="btn btn-outline-secondary" aria-label="Back to Home"
                    >Back to Home</a
                >
            </div>
        </div>
    ...
    <div class="card shadow-lg border-0" style="max-width: 28rem; margin: 0 auto;">
        ...
        <div class="card-body p-4">
            ...
            <div class="text-center">
                ...
                <a href="/login" class="text-decoration-none fw-medium" aria-label="Sign in"
                    >Sign in</a
                >
            </div>
        </div>
